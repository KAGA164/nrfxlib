 ...
 * this procedure is finished. To perform this procedure safely use a
 ...
 * @retval -ENOTSUP If the new buffer has different length than the first one.
 * @retval -EFAULT If provided buffer is the current used buffer.
 */
